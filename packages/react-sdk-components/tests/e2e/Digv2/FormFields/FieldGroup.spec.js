...
test.describe('E2E test', () => {
  ...
  test('should login, create case and run the Field Group tests', async ({ page }) => {
    ...
    await page.locator('div[data-test-id="8988e975cfff59bdd8d651296e4a9e1c"] input').fill('01/01/2024');
    ...
    await expect(page.getByText('ReadOnly Date Only')).toBeVisible();
    ...
    await expect(page.locator('div[data-test-id="8d258fbb103ba3bd191f9273a98c4714"] input')).toHaveValue('01/01/2024');
    ...
    await expect(page.locator('div[data-test-id="8d258fbb103ba3bd191f9273a98c4714"] input')).toBeHidden();

    // Expand Field Group
    await page.locator('span[id="field-group-header"] svg').click();
    await expect(page.locator('input[data-test-id="861d2d04e52d59e8b85a27fd5b4aef28"]')).toBeVisible();
    await expect(page.locator('div[data-test-id="8d258fbb103ba3bd191f9273a98c4714"] input')).toBeVisible();
  }, 10000);
});
